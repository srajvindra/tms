<div class="max-w-7xl mx-auto p-6">
    ...
    <!-- Import XLS Modal -->
    @if($showImportModal)
        <flux:modal name="import-xls-modal" wire:model="showImportModal" class="space-y-6">
            <div>
                <flux:heading size="lg">Import Tasks from XLS</flux:heading>
                <flux:text class="mt-2">Upload an XLS or XLSX file to import multiple tasks at once.</flux:text>
            </div>

            <div class="space-y-4">
                <div>
                    <flux:text size="sm" class="mb-2 font-medium">XLS Format:</flux:text>
                    <flux:text size="sm" class="text-gray-600">
                        The Excel file should have columns in this order:<br>
                ...
                <div>
                    <flux:field>
                        <flux:label>Select XLS File</flux:label>
                        <flux:input type="file" wire:model="xlsFile" accept=".xls,.xlsx" />
                        <flux:error name="xlsFile" />
                    </flux:field>
                </div>
                ...
                @if ($xlsFile)
                    <div class="flex items-center space-x-2 text-sm text-green-600">
                        ...
                        <span>File selected: {{ $xlsFile->getClientOriginalName() }}</span>
                    </div>
                @endif
            </div>
            ...
            <div class="flex justify-end space-x-3">
                ...
                <flux:button wire:click="importXls" :disabled="!$xlsFile" wire:loading.attr="disabled">
